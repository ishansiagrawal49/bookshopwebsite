...
<html lang="en">
	<head>
	    ...
	    <title>BookStore Management System Home Page</title>
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Books</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Fantasy</a></li>
					<li><a href="#books" data-toggle="tab">Thriller</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Thriller</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Fantasy</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
